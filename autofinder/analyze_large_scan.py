...
#%%
def combine(folder, crop_w = [0, 1], crop_h = [0, 1], scale = 0.2, compress = 1, bk = []):
    ...
    for i in range(len(file_list)):
        ...
        out[-start_y - roi_height: -start_y, start_x: start_x + roi_width] = img
...
#%%
def find_contours(img, bright_thresh = 50, area_thresh = 1000):
