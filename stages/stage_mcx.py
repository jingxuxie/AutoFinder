...
class Stage_MCX():
    def __init__(self):
        self.com = serial.Serial('COM5', timeout = 6)
    ...
    def initialize(self):
        ...
        self.com.write(b'25 sv ')
        self.com.write(b'200 sa ')
    ...
    def set_speed(self, speed:int):
        self.com.write((str(speed) + ' sv ').encode())

    def set_acceleration(self, acceleration:int):
        self.com.write((str(acceleration) + ' sa ').encode())
