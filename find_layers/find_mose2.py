...
from autofinder.find_layers.predict_mose2 import predict_mose2
...
def layer_search_mose2(filename, background, area_thresh = 200, thickness_range = [0.3, 2.3],
    ...
    # filename = 'F:/Temp/mose2/0812/color_shift_1/2023-08-13--17-15-31-60B000.png'
...
def test_run(background):
    filepath = 'F:/Temp/mose2/0812/color_shift_7'
    _, file_list, _ = generate_positions(filepath)
    resultpath = 'F:/Temp/mose2/0812/results_7'
    contrast_json = {'items': []}
    ...
    for finished_count in range(len(file_list)):
        ...
        ret, img_out, contrast_list, flake_position_list = layer_search_mose2(input_name, background)
...
if __name__ == '__main__':
    bk = get_background('F:/Temp/mose2/0812/color_shift_7', 1500, 1500)
