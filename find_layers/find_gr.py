...
import json
from autofinder.auxiliary_func import generate_positions, background_divide, get_background, merge_thumbnail
...
def layer_search_gr(filename, background, area_thresh = 1000, thickness_range = [0, 8],
    ...
    # filename = 'F:/Temp/gr_new/color_shift/2023-08-12--10-11-14-05B000.png'
    ...
    threshold_lo = [int(bk_color[0] * 0.65), int(bk_color[1] * 0.2), int(bk_color[2] * 0)]
    threshold_hi = [int(bk_color[0] * 1.3), int(bk_color[1] * 0.94), int(bk_color[2] * 0.94)]
